const projectData = [
  ...
  },
  {
    ...
    link:`https://chrome-history.herokuapp.com`,
  ...
  },
  {
    ...
    challenges:`I'd say the hardest part was working with old code base for the timeline as the code lived in a Wordpress project. The framework I created for the grid structure for the promo website had some problems with certain mobile browsers which took a lot of testing to fix. But the custom framework gave us a lot of freedom and speed later on as we didn't rely on any UI framework that could have caused us compatibility issues.`,
    code:`https://github.com/denizsokullu/lunar-gala`,
  ...
  },
  {
    ...
    code:`https://github.com/denizsokullu/awap-2018`,
    link:`https://awap-2018-competition.herokuapp.com`,
    techUsed:['NodeJS','Pug','Express','Firebase','Anime.js'],
  },
  {
    title:`IBM Internship + Senior Part Time Work`,
    desc:`I worked in IBM Littleton, MA last summer under my manager Ethan Perry for IBM's Collaborative Solutions Design Team. My main task throughout the summer was to research if theme customization for IBM Connections was possible via a proxy server injecting stylesheets to the responses sent to the users.  After creating initial demos for customization, this project was assigned a team and I stayed for the whole senior year of my college as a part time employee working remotely to help the team to make it accessible to everyone using Connections.`,
  ...
  },
  {
    ...
    Flipbook Generator - was my first attempt to write a simple AI that placed shapes of an vector art(mainly cute pets) randomly on the canvas and compared it to the final artwork and improved upon slowly mutating new solutions from its trials. The underlying algorithm known as the Genetic Algorithm was inspired by Dan Shiffman from Coding Train on YouTube!`,
    code:`https://github.com/denizsokullu/computational-design`,
    link:`https://computational-design.denizsokullu.com`,
  ...
  },
  {
    ...
    challenges:`Creating the pixel assets actually! Those were all done by my group consisting of Natalie Harmon, Christie Chong, Juliana Nam and me.`,
    code:`https://github.com/denizsokullu/cmu-design-census`,
    link:`https://cmu-design-census.herokuapp.com`,
    techUsed:['NodeJS','p5.js','HTML5'],
  },
  {
    title:`The Gap`,
    desc:`The final project of the Advanced Web Design class, Sara Remi Fields, Ruby He and I created a website depicting the gap in education in the US between different economic classes and locations.`,
    ...
    code:`https://github.com/denizsokullu/the-gap`,
    link:`https://the-gap.herokuapp.com/`,
